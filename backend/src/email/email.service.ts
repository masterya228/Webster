...
<body>
  <div class="wrap">
    ...
    <div class="body">
      <h2>Привіт, ${name}!</h2>
      <p>Дякуємо за реєстрацію в Vizora. Щоб активувати акаунт — підтвердіть свою електронну пошту.</p>
      ...
      <p style="font-size:13px;color:#bbb">Посилання дійсне 24 години.</p>
    </div>
...
<body>
  <div class="wrap">
    ...
    await this.send(to, 'Скидання пароля Vizora', html);
  }
